  ...
  return (
    <PublicShell>
      <section className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between gap-12">
              <div>
                ...
                <h1 className="mt-5 text-4xl font-bold leading-tight tracking-tight text-white">
                  Join OFENetworks and start transacting.
                </h1>

                <p className="mt-4 text-sm leading-7 text-emerald-100/70">
                  Create your account in seconds and gain access to manual
                  confirmations, proof uploads, bonus-aware transactions, and
                  admin review tools.
                </p>
              </div>
        ...
        <Suspense fallback={<div className="rounded-[32px] border border-[#e7eee9] bg-white p-8 shadow-[0_12px_30px_rgba(15,23,32,0.06)]"><p className="text-sm text-slate-500">Loading sign up...</p></div>}>
          <RegisterForm />
        </Suspense>
      </section>
    </PublicShell>
